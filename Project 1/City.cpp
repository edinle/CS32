...
City::City(int nRows, int nCols)
 : m_rows(nRows), m_cols(nCols), m_player(nullptr), m_nTooters(0), m_history(nRows, nCols)  // also includes m_history
{
...
void City::preachToTootersAroundPlayer()
{
    ...
    for (int k = 0; k < m_nTooters; )
    {
        ...
        {
            // Notify history of the converted Tooter's location
